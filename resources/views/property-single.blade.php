                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="property-contact">
                                <form class="form-a" method="post" action="{{ route('property-single.store') }}">
                                    @if (session('status'))
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-1">
                                            <div class="form-group">
                                                <textarea id="textMessage" class="form-control" placeholder="Comment *" name="comments" cols="45" rows="8"
                                                    required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
